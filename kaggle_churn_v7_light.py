...
RETRAIN_SEEDS        = 2        # LIGHT: 5 → 2 (süre tasarrufu)
OPTUNA_SUBSET_TRIALS = 500      # LIGHT: 1000 → 500
USE_GPU              = True
USE_OPTUNA_SUBSET    = True     # False → tüm OOF'ları kullan
USE_ORIGINAL_DATA    = True     # Orijinal Telco veri setini kullan
USE_GP_FEATURES      = False    # LIGHT: Kapalı (~30 dk tasarruf)
USE_DVAE             = False    # LIGHT: Kapalı (~5 dk tasarruf)
DVAE_LATENT_DIM      = 12       # VAE latent boyutu
DVAE_EPOCHS          = 20       # VAE eğitim epoch
GP_GENERATIONS       = 5        # GP evrim nesil
GP_POPULATION        = 200      # GP popülasyon
